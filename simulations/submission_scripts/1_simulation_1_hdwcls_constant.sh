...
#\$SLURM_ARRAY_TASK_ID
seeds=1000
pt_settings=("Aconstant")
responder_settings=("Z1dependent") #"constant" 
write_slurm() {
    echo "#!/bin/bash
#SBATCH --job-name=hdwcls_$1_$2_N$3
...
Rscript --verbose ../1_simulation_1_hdwcls_constant.R \$SLURM_ARRAY_TASK_ID $1 $2 $3" > sim_hdwcls_$1_R$2_N$3.slurm
if $4
then
    sbatch sim_hdwcls_$1_R$2_N$3.slurm
fi
}
